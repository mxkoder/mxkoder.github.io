  ...
  opacity: 0.6;
    ...
    <footer id="footer"> 
      <section id="social-media-links">
        ...
        <a href="https://www.agnesbeviz.co.uk/" id="link_to_home_page"><img alt="Cartoonised portrait" src="/images/portrait-ab-stylized.png" width=30px height=30px id="stylised_portrait"></a>
        </section>
